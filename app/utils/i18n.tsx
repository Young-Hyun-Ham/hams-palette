...
const dictionary: Record<Locale, Record<string, string>> = {
  ...
  ko: {
    ...
    "user id": "사용자 ID",
    "template id": "템플릿 ID",
    "enter a user id": "사용자 ID를 입력하세요",
    "enter a template id": "템플릿 ID를 입력하세요",
    "public url": "공개 주소",
    ...
    "layer palette": "레이어 팔레트",
    "tab palette": "탭 팔레트",
    "menu palette": "메뉴 팔레트",
    "flexible content area": "유연한 콘텐츠 영역",
    "section container": "섹션 컨테이너",
    "drag": "드래그",
    "hero": "히어로",
    "intro": "인트로",
    "visual": "비주얼",
    ...
    "layer content palette": "레이어 콘텐츠 팔레트",
    "add": "추가",
    "active tab content": "활성 탭 콘텐츠",
    "layer content blocks": "레이어 콘텐츠 블록",
    "no blocks in this layer yet.": "이 레이어에 아직 블록이 없습니다.",
    ...
    "italic": "기울임",
    "strike": "취소선",
    "content border": "콘텐츠 테두리",
    "palette border": "팔레트 테두리",
    "image border": "이미지 테두리",
    "border width": "테두리 굵기",
    "controls whether the selected palette shows a border.": "선택된 팔레트에 테두리를 표시할지 여부를 제어합니다.",
    "controls whether text and image content shows a border.": "텍스트 및 이미지 콘텐츠에 테두리를 표시할지 여부를 제어합니다.",
    "open emoji and text picker": "이모지 및 텍스트 선택 열기",
    "size": "크기",
    "font size": "글자 크기",
    "spacing": "여백",
    "content spacing": "콘텐츠 여백",
    "selected image": "선택된 이미지",
    "click to select image": "클릭해서 이미지 선택",
    "emoji": "이모지",
    "text": "텍스트",
